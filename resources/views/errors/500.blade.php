...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 64px; font-weight: 700; color: #ef4444; line-height: 1; }
        h1 { font-size: 22px; margin: 16px 0 8px; }
        p { font-size: 14px; color: #71717a; line-height: 1.6; margin-bottom: 24px; }
        a {
...
<body>
    <div class="card">
        ...
        <p>We hit an unexpected error. Our team has been notified. Please try again in a few minutes.</p>
